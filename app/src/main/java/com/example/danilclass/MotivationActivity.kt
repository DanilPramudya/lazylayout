package com.example.danilclass
...
import com.example.danilclass.data.ListMotivation
import com.example.danilclass.model.Motivation
...
class MotivationActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MotivationApp(
                listMotivation = ListMotivation().loadMotivation())
        }
    }
}
